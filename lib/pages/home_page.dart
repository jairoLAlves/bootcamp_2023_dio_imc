...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    homePageController.loaderPessoa();
          ...
          drawer: Drawer(
            child: Column(
              children: [
                ...
                Expanded(
                    child: ListView(
                  children: homePageController.pessoaAtual?.getListImc
                          .map(
                            (imcItem) => Card(
                              child: ListTile(
                                leading: CircleAvatar(
                                    child: Text('${imcItem.imc.round()}')),
                                trailing: Text(
                ...
                child: Container(
                  child: Stack(children: [
                    Container(
                        ...
                        child:
                            Text('Status: ${homePageController.imcMessage}')),
                    Row(
